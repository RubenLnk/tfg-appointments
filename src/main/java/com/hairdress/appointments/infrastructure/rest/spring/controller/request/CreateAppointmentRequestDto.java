...
public class CreateAppointmentRequestDto {
    ...
    @ApiModelProperty(value = "ID del cliente que recibe la cita", example = "1")
    @NotNull(message = "El ID del cliente es obligatorio")
    @JsonProperty("customerId")
    private Long customerId;

    @ApiModelProperty(value = "ID del profesional que crea la cita", example = "1")
    @JsonProperty("professionalId")
    private Long creatorProfessionalId;
